...
@section('content')
    <div class="container">
        <div class="my-3">
            <h1 class=" display-5 fw-bold"> Hi, {{ $user->name }} </h1>
        ...
        <div class="mt-3 d-flex flex-column flex-lg-row justify-content-center align-items-center gap-4">
            <div class="card">
                ...
                <div class="card-body">
                    <a class="btn bg_secondary  btn-lg" href="{{ route('dress.index') }}" role="button">Your
                        Dresses</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <a class="btn bg_secondary  btn-lg" href="{{ route('brand.index') }}" role="button">Your
                        Brands</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <a class="btn bg_secondary  btn-lg" href="{{ route('outfit.index') }}" role="button">Your
                        Outfits</a>
                </div>
            </div>
        </div>
